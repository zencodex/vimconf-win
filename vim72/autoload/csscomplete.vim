...
elseif borders[max(keys(borders))] == 'colon'
	...
	elseif prop == 'empty-cells'
		let values = ["show", "hide", "inherit"]
	elseif prop == 'float'
		let values = ["left", "right", "none"]
	elseif prop == 'font-family'
		let values = ["sans-serif", "serif", "monospace", "cursive", "fantasy", "\\5FAE\\8F6F\\96C5\\9ED1"]
	...
	elseif prop == 'overflow' || prop=='overflow-x' || prop=='overflow-y'
...
elseif borders[max(keys(borders))] == 'atrule'
	...
	let values = ["charset", "page", "media", "import", "font-face", "namespace", "phonetic-alphabet"]
