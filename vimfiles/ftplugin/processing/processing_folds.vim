...
if exists('g:processing_folding')
    finish
endif
let g:processing_folding=1

function! ProcessingFolding()
...
"setl fen
au BufNewFile,BufRead,BufEnter *.pde call ProcessingFolding()
au BufNewFile,BufRead,BufEnter *.pde setl fen
